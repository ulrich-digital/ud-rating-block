...
register_activation_hook(__FILE__, function () {
    $defaults = [
        ...
        'ud_rating_display_delay'             => 6,
        'ud_rating_enable_confetti'           => true,
        'ud_rating_text_launcher'             => 'Feedback',
        'ud_rating_text_question'             => 'Gefällt Dir die neue Website?',
        'ud_rating_text_rating_thanks'        => 'Vielen Dank für deine Bewertung.',
        'ud_rating_text_thanks'               => 'Vielen Dank für dein Feedback.',
        'ud_rating_text_comment_placeholder'  => 'Deine Meinung interessiert uns.',
        'ud_rating_text_comment_button'       => 'Feedback senden',
        'ud_rating_google_link_company'       => '',
        'ud_rating_text_google_company'       => 'Möchtest du deine Bewertung auf Google teilen?',
        'ud_rating_text_button_company'       => 'Bewertung auf Google teilen',
